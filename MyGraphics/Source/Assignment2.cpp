...
void Assignment2::Render()
{
	...
	#pragma region Environment Objects
		modelStack.PushMatrix();
				modelStack.Translate(0, -30, -12.5);

		modelStack.PushMatrix();
				modelStack.Translate(-3, 15, 0);
				RenderText(meshList[GEO_TEXT], "Fountain", (1, 0, 0));
		...
		modelStack.PushMatrix();
				modelStack.Translate(0.25, -31, 30);
				modelStack.Rotate(90, 0, 1, 0);
				modelStack.Scale(0.15, 0.15, 0.15);
				RenderMesh(meshList[GEO_ELECTRICBOX], true);
		modelStack.PopMatrix();
	...
	#pragma region LAMPPOST RENDER AND LIGHTS
		modelStack.PushMatrix();
				modelStack.Translate(-19, -32.5, 12);
	...
	#pragma region SIDE CARS
			//CAR 2
			modelStack.PushMatrix();
					modelStack.Translate(translateAmt, car2.GetPosition().y, car2.GetPosition().z);
					modelStack.Rotate(90, 0, 1, 0);
					modelStack.Scale(2, 2, 2);
			RenderMesh(meshList[GEO_CAR2], true);

			modelStack.PushMatrix();
					RenderMesh(meshList[GEO_CAR2_STEERING], true);

			modelStack.PushMatrix();
					RenderMesh(meshList[GEO_CAR2_WHEELS], true);
			...
			//CAR 3
			modelStack.PushMatrix();
					modelStack.Translate(-translateAmt, car3.GetPosition().y, car3.GetPosition().z);
					modelStack.Rotate(-90, 0, 1, 0);
					modelStack.Scale(2, 2, 2);
			RenderMesh(meshList[GEO_CAR3], true);

			modelStack.PushMatrix();
					RenderMesh(meshList[GEO_CAR3_STEERING], true);

			modelStack.PushMatrix();
					RenderMesh(meshList[GEO_CAR3_WHEELS], true);
	...
	#pragma region TREES RENDER
		//TOP RIGHT PORTION OF TREES RELATIVE TO CAMERA STARTING POS.

		modelStack.PushMatrix();
				modelStack.Translate(-47.5, -28.25, 39);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-44.5, -28.25, 39);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-41.5, -28.25, 39);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-38.5, -28.25, 39);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-35.5, -28.25, 39);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-32.5, -28.25, 39);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-29.5, -28.25, 39);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-29.5, -28.25, 36);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-29.5, -28.25, 33);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-26.5, -28.25, 48);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-26.5, -28.25, 45);
				modelStack.Scale(1.2, 1.2, 1.2);
		RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-26.5, -28.25, 42);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-26.5, -28.25, 39);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-26.5, -28.25, 36);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();

		modelStack.PushMatrix();
				modelStack.Translate(-26.5, -28.25, 33);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();
		...
		modelStack.PushMatrix();
				modelStack.Translate(-32.5, -28.25, 13);
				modelStack.Scale(1.2, 1.2, 1.2);
				RenderMesh(meshList[GEO_TREE], true);
		modelStack.PopMatrix();
		...
		//END OF TREES AT RIGHT SIDE OF THE MAP

		//START OF TREE  AT LEFT SIDE OF THE MAP
		...
		//END OF TREE   AT TOP LEFT PORTION OF TREES RELATIVE TO CAMERA STARTING POS.
	#pragma endregion

	#pragma region HOUSE AND FENCES AND TREES RENDER
		// RIGHT SIDE
		modelStack.PushMatrix();
		modelStack.Translate(-37.5, -30, 26);
		modelStack.Rotate(180, 0, 1, 0);
		...
		modelStack.PushMatrix();
		modelStack.Translate(-37.5, -30, 0);
		modelStack.Rotate(180, 0, 1, 0);
		RenderMesh(meshList[GEO_HOUSE], true);
		modelStack.PopMatrix();
		...
		//FRONT SIDE
		modelStack.PushMatrix();
		modelStack.Translate(-13.5, -30, 37.5);
		modelStack.Rotate(270, 0, 1, 0);
		RenderMesh(meshList[GEO_HOUSE], true);
		modelStack.PopMatrix();
